package complex_data_structures;
...
public class App {
    ...
    public static void main(String[] args) {
        // vehicle, list of qualified drivers
        ...
        { // Brackets just to scope driversList variable so same name can be reused
            // Example usage
        ...
        System.out.println("***Iterate through the whole thing***");
